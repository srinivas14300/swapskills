...
const Features = () => {
  const features = [
    {
      title: 'User Skill Profiles',
      description: 'List skills to teach and learn with descriptions.',
    },
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
          {features.map((feature, index) => (
            <div
              key={index}
              className="feature-item bg-white text-gray-900 p-6 rounded-lg shadow-md flex flex-col justify-between"
            >
